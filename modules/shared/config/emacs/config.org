...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-x K") 'kill-bffer)
#+END_SRC
...
#+RESULTS: :org-roam-templates
| d | default | entry | * %? | :if-new | (file+head %<%Y-%m-%d>.org (lambda nil (concat :PROPERTIES: |
