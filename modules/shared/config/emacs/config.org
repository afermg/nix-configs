  ...
  (use-package meow
    ...
    (defun meow-setup ()
      ...
      (meow-define-keys 'normal
        ...
        ;; version control
        '(";v" . +vc/browse-at-remote-kill-commit)
        '(";V" . +vc/browse-at-remote-kill)
...
#+begin_src emacs-lisp 
  ...
  (defun +vc/browse-at-remote-kill-commit (&optional interactive?)
    "Copy URL to current file (and line if selection is active) using the commit hash to clipboard."
    (interactive (list 'interactive))
    (require 'browse-at-remote)
    (+vc/browse-at-remote-kill (if browse-at-remote-prefer-symbolic t nil) interactive?))
