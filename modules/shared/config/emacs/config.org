  ...
  (use-package meow
    ...
    (defun meow-setup ()
      ...
      (meow-define-keys 'normal
        ...
        '(";oT" . +vterm/here)
        '(";ox" . afermg/toggle-scratch-buffer)
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-x k") 'afermg/kill-this-buffer)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun afermg/toggle-window-bottom (buffer-name fn-create-buffer)
    ...
    (defun afermg/toggle-scratch-buffer ()
      (interactive)
