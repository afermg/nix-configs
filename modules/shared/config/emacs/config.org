...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'line-number nil :inherit 'fixed) ; This was in earlier in the confi gbut stopped working there
...
#+begin_src emacs-lisp
  ...
  (setq gptel-api-key "XXXXXXXXXXXXXXXXXXXXXXXXX")
