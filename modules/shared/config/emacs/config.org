...
**** COMMENT Undo-tree
# Deactivated because it slows down org-mode saving quite a lot
Undo tree for better undo visualisation.
#+BEGIN_SRC emacs-lisp
  (use-package undo-tree
    ...
    :config
    ;; Save undo history to a dedicated directory to avoid cluttering working directories
