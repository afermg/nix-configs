...
#+begin_src emacs-lisp
  (use-package langtool
    :config
    (setq langtool-language-tool-jar (file-name-concat (file-name-parent-directory (file-name-parent-directory (file-truename (executable-find "languagetool-commandline")))) "share" "languagetool-commandline.jar"))
